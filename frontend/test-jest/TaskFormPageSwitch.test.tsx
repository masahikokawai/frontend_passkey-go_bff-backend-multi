...
import TaskFormPageSwitch from "../src/features/tasks/TaskFormPageSwitch";

// src/features/tasks/TaskFormPageSwitch.test.tsx (Vitest版)と同じ内容のJest版
jest.mock("../src/features/tasks/TaskFormPage", () => ({
  __esModule: true,
  default: ({ mode }: { mode: string }) => <div data-testid="new-impl-marker">{mode}</div>,
}));
jest.mock("../src/features/tasks/legacy/TaskFormPage", () => ({
  __esModule: true,
