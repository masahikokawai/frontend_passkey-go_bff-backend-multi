...
//
// この.protoはbackend/proto/task/v1/task.proto(正)の複製
// 統合レビューで両モジュールが独立にprotoを書いて食い違っていたことが判明したため、
// backendの契約に合わせて同期した(go_packageの行のみ異なる)
// 本来はbuf等で契約を1箇所管理し両モジュールへ配布するのが望ましいが、
// 今回は学習目的の2モジュール構成のため.protoを複製して同期している
