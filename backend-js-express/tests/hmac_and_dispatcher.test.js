...
// backend-java/HmacAndDispatcherTest.java・backend-python/test_hmac_and_dispatcher.pyの移植。
// HmacVerifier単体とDispatcherの振り分けロジックを検証する(DB不要)
const test = require('node:test');
const assert = require('node:assert/strict');
const { HmacVerifier, Dispatcher, isLocalIssuer, LOCAL_HMAC_ISSUER, LOCAL_RSA_ISSUER, VerifyError } = require('../src/auth/jwt');
const { makeHmacToken, makeAlgNoneToken } = require('./support/test_token_helper');
